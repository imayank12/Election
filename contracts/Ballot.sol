...
contract Ballot is VoterList {
  ...
  // Check whether the voting period is open
 ...
 //Checks whether the vote casting is period has already elapsed.
    modifier hasClosed() {
  ...
  //Get User voted candidate name
     ...
     * @return retruns candidate name if the user casted their vote
     */
    function getResults() hasClosed internal view returns(Candidate[] memory) {
        return candidates;
    }
